...
#: Alarm proxy to :class:`plyer.facades.Alarm`
alarm = Proxy('alarm', facades.Alarm)
...
#: NetCheck proxy to :class: `plyer.facades.NetCheck`
netcheck = Proxy('netcheck', facades.NetCheck)
...
#: Social proxy to :class:`plyer.facades.Social`
social = Proxy('social', facades.Social)
